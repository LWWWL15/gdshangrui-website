  ...
  <div class="products-page">
    <section class="page-hero">
      <div class="container">
        ...
        <h1>{{ t('主要产品系列', 'Our Product Lines',  t('主要产品系列', 'Our Product Lines', 'Dòng sản phẩm chính', 'Основные серии продукции'),  t('主要产品系列', 'Our Product Lines', 'Dòng sản phẩm chính', 'Основные серии продукции')) }}</h1>
        ...
        <div class="series-grid">
          ...
          >
            ...
            <div class="series-info">
              ...
              <p class="series-desc">{{ t(series.descCn, series.descMic,  series.descVn,  series.descVn) }}</p>
              <div class="series-models">
                <span class="model-count">{{ series.models.length }} {{ t('个型号', 'Models',  t('个型号', 'Models', 'mẫu', 'моделей'),  t('个型号', 'Models', 'mẫu', 'моделей')) }}</span>
              </div>
              <span class="view-more">{{ t('查看详情 →', 'View Details →',  t('查看详情 →', 'View Details →', 'Xem chi tiết →', 'Подробнее →'),  t('查看详情 →', 'View Details →', 'Xem chi tiết →', 'Подробнее →')) }}</span>
            </div>
          </router-link>
        </div>
      </div>
